...
//
//     final tableTvshowsModel = tableTvshowsModelFromJson(jsonString);

import 'dart:convert';

List<TableTvshowsModel> tableTvshowsModelFromJson(String str) =>
    List<TableTvshowsModel>.from(
      json.decode(str).map((x) => TableTvshowsModel.fromJson(x)),
    );

String tableTvshowsModelToJson(List<TableTvshowsModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class TableTvshowsModel {
  int id;
  String url;
  String name;
  Type type;
  ...
  factory TableTvshowsModel.fromJson(
